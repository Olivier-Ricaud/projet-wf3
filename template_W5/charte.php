<main id="charte_CGU" class="container-fluid">
	...
	<div class="row">
		...
		<p>Le terme « données à caractère personnel » désigne toutes les données qui permettent d'identifier un individu, ce qui correspond notamment à vos nom, prénoms, pseudonyme, photographie, adresses postale et de courrier électronique, numéros de téléphone, date de naissance, données relatives à vos transactions sur le site, détails de vos achats et abonnements, numéros de carte bancaire, ainsi qu'à tout autre renseignement que vous choisirez de nous communiquer à votre sujet.</p>

		<h2>2. Objet de la présente charte</h2>

		<p>La présente charte a pour objet de vous informer sur les moyens que nous mettons en œuvre pour collecter vos données à caractère personnel, dans le respect le plus strict de vos droits.</p>

		<p>Nous vous indiquons à ce sujet que nous nous conformons, dans la collecte et la gestion de vos données à caractère personnel, à la loi n° 78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés, dans sa version actuelle.</p>

		<h2>3. Identité du responsable de la collecte de données</h2>

		<p>Le responsable de la collecte de vos données à caractère personnel est la société WeFive SARL, immatriculée au Registre du Commerce et des Sociétés de Paris sous le n° 00000000000 , ayant son siège social 82, avenue Denfert Rochereau 75014 PARIS.</p>
		...
		<li>Elaborer des statistiques commerciales et de fréquentation de nos services;</li>
		...
		<li>Gérer les impayés et les contentieux éventuels quant à l'utilisation de nos produits et services;
		Respecter nos obligations légales et réglementaires;</li>
		</ul>
		...
		<p>Le personnel de notre société, les services chargés du contrôle (commissaire aux comptes notamment) et nos sous-traitants auront accès à vos données à caractère personnel.</p>
		...
		<p>Concernant les données relatives à la gestion de clients et prospects :<br />
		...
		<p>Concernant les pièces d'identité : <br />
		...
		Les transactions financières relatives au paiement des achats et des frais via le site, sont confiées à un prestataire de services de paiement qui en assure le bon déroulement et la sécurité.</p>
		...
		<p>Pour vous permettre de réaliser régulièrement des achats ou de régler les frais afférents sur le site, vos données relatives à vos cartes bancaires sont conservées pendant le temps de votre inscription sur le site et à tout le moins, jusqu'au moment où vous réalisez votre dernière transaction.</p>

		<p>En ayant coché sur le site la case expressément prévue à cet effet, vous nous donnez votre consentement exprès pour cette conservation.</p>
		...
		<p>Concernant la gestion des listes d'opposition à recevoir de la prospection :
		Les informations permettant de prendre en compte votre droit d'opposition sont conservées au minimum trois ans à compter de l'exercice du droit d'opposition.</p>

		<p>Concernant les statistiques de mesure d'audience : <br />
		Les informations stockées dans le terminal des utilisateurs ou tout autre élément utilisé pour identifier les utilisateurs et permettant leur traçabilité ou fréquentation ne seront pas conservées au-delà de 6 mois.</p>
		...
		<ul>
			<li>adresse de courrier électronique : w5@wefive.com</li>
			<li>adresse de courrier postal : 82 avenue Denfert Rochereau - 75014 PARIS</li>
		</ul>
		...
		<p>La présente charte est entrée en vigueur le 27 décembre 2016.</p>
	</div>
</main>